...
///
/// Comments are classified into leadComments, innerComments and trailComments based on the location relationship between
...
struct CommentGroups {
    std::vector<CommentGroup> leadComments;
